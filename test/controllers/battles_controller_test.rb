...
class BattlesControllerTest < ActionController::TestCase
  ...
  test "should create battle" do
    assert_difference('Battle.count') do
      post :create, battle: { lose_ankle_id: @battle.lose_ankle_id, user_id: @battle.user_id, win_ankle_id: @battle.win_ankle_id }
    end
  ...
  test "should update battle" do
    patch :update, id: @battle, battle: { lose_ankle_id: @battle.lose_ankle_id, user_id: @battle.user_id, win_ankle_id: @battle.win_ankle_id }
    assert_redirected_to battle_path(assigns(:battle))
  end
